...
/*
     1)An interface cannot have "concrete method" therefore all methods in interface should be abstract.
     ...
     7)Whenever you need to call any variables use "Interface Name" to call.
