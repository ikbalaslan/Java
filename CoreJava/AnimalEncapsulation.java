...
6)It is impossible to create "object" from "abstract class" but it does not mean " abstract classes" do not have "constructors"
...
8)Concrete methods are may or may not be  overridden by child classes
...
//Abstract methods just showing what to do.
//Regular methods show what to do and how to do.
