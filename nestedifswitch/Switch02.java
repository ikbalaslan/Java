...
public class Switch02 {
    public static void main(String[] args) {
        ...
        System.out.println("Enter mont number");
        ...
        /*
        "Break" keyword is used in "switch" statement to stop next executions.
"break" keyword takes us the outside the switch stament
