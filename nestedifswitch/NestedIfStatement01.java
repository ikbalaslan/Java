...
public class NestedIfStatement01 {
     ...
     */
        ...
        char pwdInitial = input.next().charAt(0);//charAt() method returns just a single character, data type in Java for single characters in "char"
                                                 // Because of that I used char data type for pwd container
