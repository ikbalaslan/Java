...
public class E02 {
    ...
    3)"ArithmeticException", "NullPointerException", "ArrayIndexOutOfBoundsException", "NumberFormatException", "StringIndexOutOfBoundException
      "IllegalArgumentException" are displayed on the console after I click on "Run button" therefore, those are called "RunTime Exception".
    4)There is "Compile Time Exception", they will be displayed before clicking on the "RunButton".
