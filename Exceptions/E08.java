...
public class  E03 {
    ...
    6)When you use parent and child exception classes together in a try-catch,
      child classes must be a first otherwise Java gives error.

    7)When you encounter a "Compile Time Exception", you have 2 options
       i)Using "throws" in method signature line
             *Java will throw exception and stop execution.
       ii)Using try-catch block
              *Java will execute whatever you type inside the catch body and doesn't stop the execution.
     ...
     8)What is the difference between "throw" and "throws" keywords?
        ***  i) "throw" keyword is used to throw any Exception in anywhere inside the method body.
        ...
        ii)By using "throws" keyword you can declare multiple exceptions
           After using "throw" keyword you can declare only one exception.
        iii)After using "throw" keyword, you have to create an exception object.
            After using "throws" keyword, you will call just the name of the exception class.

      9)What is the difference between "Exception" and "Error" ?
         i)"Exception" can be handled but "Error" cannot.
         OutOfMemory, StackOutOfMemory, VirtualMachine, Assertion can be example for "Error".
   ...
   readTheTextFromTheFile();
    ...
    //If the path is wrong, of the file does not exist, if the text cannot be read stop execution.
public static void readTheText() throws IOException {
    ...
    // if the file does not exist, if the text cannot be read stop execution.
